...
% Part 4: Nucleoid centring upon ciprofloxacin exposure
\subsection*{Ciprofloxacin induces centring of the bacterial nucleoid}
...
%% We correlate Nucleoid and RecB position and find that they are correlated
%% Interpretation: RecB spot centring is due to nucleoid centring (not obvious: link to DSB rate, explain it happens after several rounds of DSBs)
