...
%% To understand this we imaged the bacterial nucleoid with Sytox
%% It appears the nucleoid is centred (but not compacted) upon cipro addition
This is consistent with RecN-dependent, SOS-induced compaction of the bacterial chromosome upon DNA damage, as has been previously reported\cite{Odsbu2014}.
...
Zooming on the tails of the RecB spot lifetime histograms reveals there is a fraction of very long-lived RecB spots (> 50 sec) which are not well accounted for by our bi-exponential fit.
