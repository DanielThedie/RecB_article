...
To further characterise the long-lived DNA binding events, we defined a spot lifetime threshold (10 sec), at which 95\% of the RecB spots observed under Gam overexpression are shorter than the threshold (Figure \ref{Fig:nspots}D).
