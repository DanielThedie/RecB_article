...
We found that dissociation of RecBCD from DNA is an intrinsic property of the complex, and does not depend on the amount of DNA damage, or the following steps in the repair pathway.
% General sentence on what the article contributes
This study brings in-depth insight into the binding of RecBCD to DNA in \ecoli\ \emph{in-vivo}, and into the cell's response to ciprofloxacin-induced double-strand breaks.
