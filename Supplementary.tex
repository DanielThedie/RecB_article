...
\begin{suppfigure*}[htbp]
    ...
    \end{center}
    \caption{Evolution over time of the average cell length of wild-type (reproduced from Supp. Figure \ref{SIFig:Gam_cell_length} for comparison) and \dreca\ and \geneteneighty\ mutant strains exposed or not to ciprofloxacin (30 ng/ml). Black dots represent average cell lengths for individual datasets, and coloured bars the median values between them. \ncells{56,131}.}
