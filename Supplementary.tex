...
\begin{supptable}[htbp]
    ...
    \begin{tabular}{lll}
        ...
        AL119 & MG1655 \textit{recB::halotag pBad::GamL} & this work \\ % = AL119, to be updated to MEK
...
\begin{suppfigure*}[htbp]
    ...
    \end{center}
    \caption{\textbf{(A)} Histograms of RecB spot lifetime (bars) in cells over-expressing the Gam protein with overlaid bi-exponential decay fits ($y=a_1.e^{-k_1.t} + a_2.e^{-k_2.t}$, black line) and individual fit components (dashed lines). \ncells{8,812}. \nspots{18,698} \textbf{(B)} Zoom on the tail of the histograms from (A).}
